# Maven Plugin Integration Testing 1.1.4, released 2025-??-??
...
* Updated `commons-io:commons-io:2.16.1` to `2.20.0`
* Updated `org.apache.maven:maven-model:3.9.7` to `3.9.11`

### Runtime Dependency Updates

* Updated `org.jacoco:org.jacoco.agent:0.8.12` to `0.8.14`
...
* Updated `com.exasol:project-keeper-maven-plugin:4.3.3` to `5.4.3`
...
* Updated `org.apache.maven.plugins:maven-failsafe-plugin:3.2.5` to `3.5.4`
* Updated `org.apache.maven.plugins:maven-gpg-plugin:3.2.4` to `3.2.8`
* Updated `org.apache.maven.plugins:maven-install-plugin:3.1.2` to `3.1.4`
* Updated `org.apache.maven.plugins:maven-javadoc-plugin:3.7.0` to `3.12.0`
* Updated `org.apache.maven.plugins:maven-site-plugin:3.12.1` to `3.21.0`
* Updated `org.apache.maven.plugins:maven-surefire-plugin:3.2.5` to `3.5.4`
* Updated `org.codehaus.mojo:exec-maven-plugin:3.0.0` to `3.5.1`
...
* Updated `org.sonarsource.scanner.maven:sonar-maven-plugin:4.0.0.4121` to `5.2.0.4988`
